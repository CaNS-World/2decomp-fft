...
FFT ?= #fftw3,fftw3_f03,generic,mkl
PARAMOD = #multicore,gpu
...
#######FFT settings##########
ifeq ($(FFT),fftw3)
  FFTW3_PATH ?= /lscratch/smhk2/Software/AMD/amd-fftw
  ...
  FFTW3_PATH ?= /scratch/smhk2/Software/fftw-intel
  FFTW3_PATH_INCLUDE ?= $(FFTW3_PATH)/include
  FFTW3_PATH_LIB ?= $(FFTW3_PATH)/lib
  INC=-I$(FFTW3_PATH_INCLUDE)
  LIBFFT=-L$(FFTW3_PATH_LIB) -lfftw3 -lfftw3f
  ...
  CUFFT_PATH=/lscratch/smhk2/Software/Nvidia/HPC_SDK/Linux_x86_64/21.9/math_libs                                
  INC=-I${NVHPC_ROOT}/compilers/include
